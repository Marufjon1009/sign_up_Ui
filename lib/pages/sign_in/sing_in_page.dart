...
import 'package:flutter_lesson_3/widget/custom_button.dart';
import 'package:flutter_lesson_3/widget/login_filed.dart';
import 'package:flutter_lesson_3/widget/password_filed.dart';
      ...
      if (mounted) {
        showCupertinoDialog(
            ...
            builder: (context) => CupertinoAlertDialog(
                  content: Center(
                    child:
                        Lottie.asset('assets/lottie/succes.json', width: 200),
                  ),
                ));
              ...
              Padding(
                ...
                child: PasswordField(
                  ...
                  validator: (value) => value!.isEmpty || value.length < 6
                      ? "password xato yoki 6 ta belgidan kam"
                      : null,
                ),
              ),
              Padding(
